un errore di approssimazione, per cui abbiamo bisogno di dei metodi per arrotondare i numeri.

#### Arrotondamento a più vicino

L'arrotondamento a più vicino è il metodo più semplice per arrotondare un numero, la logica che sta dietro a questa tecnica è molto semplice:
- Se la cifra successiva al numero da arrotondare è inferiore o uguale a $4$ allora si arrotonda per difetto.
- Se la cifra successiva al
...
<h1  style="text-align: center;"> Arrotondamenti </h1>
...
Ad esempio nella rappresentazione a virgola mobile IEEE754, con 32 bit abbiamo:
- 1 bit per il segno.
- 23 bit per la mantissa.
- 8 bit per l'esponente.

Questo significa che non possiamo rappresentare tutti i numeri reali ottenendo
