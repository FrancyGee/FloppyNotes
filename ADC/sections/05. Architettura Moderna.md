...
Il **Frame Pointer (FP)** punta alla fine del programma.
...
int main()
{
	...
	//int *ptr = (int *)calloc(sizeof(int), dim);
...
- **write back** copio solamente nella cache finché non ho modificato quel dato.

- **write through** quando non sono sicuro dell'affidabilità dei dati e copio sia in cache che in ram.
